...
%=============================================================================
% Figure 2: Zero-SE 현상 요약 (3-panel) - 정렬 버전
%=============================================================================
...
% Panel A: 파이 차트
\begin{scope}[yshift=1.2cm]  % 파이 중심을 위로
    \def\radius{1.1}
    \fill[primaryblue!50] (0,0) circle (\radius);
    \fill[hallred!60] (0,0) -- (90:\radius) arc (90:21.6:\radius) -- cycle;
    
    \node[font=\scriptsize, white] at (55:0.7) {\textbf{19\%}};
    \node[font=\scriptsize, white] at (-70:0.6) {\textbf{81\%}};
    
    % 범례 (파이 오른쪽)
    \fill[hallred!60] (1.4,0.3) rectangle (1.65,0.5);
    \node[font=\tiny, anchor=west] at (1.7, 0.4) {Zero-SE};
    \fill[primaryblue!50] (1.4,-0.1) rectangle (1.65,0.1);
    \node[font=\tiny, anchor=west] at (1.7, 0) {Non-Zero};
\end{scope}
% Panel A 제목 (고정 위치)
...
\begin{scope}[xshift=5cm]
    ...
    \fill[hallred!60] (0.3,0) rectangle (0.95,2.0);
    \node[font=\scriptsize] at (0.625,2.15) {\textbf{28}};
    
    \fill[normgreen!60] (1.3,0) rectangle (1.95,0.71);
    \node[font=\scriptsize] at (1.625,0.86) {\textbf{10}};
    
    \node[font=\tiny] at (0.625,-0.2) {환각};
    \node[font=\tiny] at (1.625,-0.2) {정상};
    
    \node[font=\tiny, anchor=east] at (-0.05,0) {0};
    \node[font=\tiny, anchor=east] at (-0.05,2.0) {28};
\end{scope}
\node[font=\scriptsize\bfseries] at (5+1.1,-0.5) {(b) Zero-SE 구성};
\node[font=\tiny, text=black!60] at (5+1.1,-0.85) {환각률: 73.7\%};
...
\end{scope}
\node[font=\scriptsize\bfseries] at (9.2+0.8,-0.5) {(c) Zero-SE 탐지};
